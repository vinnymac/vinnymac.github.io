...
# For audio you can use the built in Audio Constructor!
...
sound.canPlayType 'audio/mpeg'

```
All of the examples above would also work for audio, just replace the #movie id with the #mp4 id. HTML5 is very feature rich. You can get just about any of the information that you could want when using these APIs. I only went over a few of the [events that HTML5 offers](https://developer.mozilla.org/en-US/docs/Web/Guide/Events/Media_events). I recommend reading over the rest to get a better grasp of the available tools.
